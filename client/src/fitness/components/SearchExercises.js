    ...
    <Typography fontWeight={700} sx={{ fontSize: { lg: '44px', xs: '30px' } }} mb="49px" textAlign="center">
      ...
      <Box position="relative" mb="72px">
        <TextField
          ...
          type="text"
        />
        <Button className="search-btn" sx={{ bgcolor: '#031728', color: '#fff', textTransform: 'none', width: { lg: '173px', xs: '80px' }, height: '56px', position: 'absolute', right: '0px', fontSize: { lg: '20px', xs: '14px' } }} onClick={handleSearch} >
          Buscar
        </Button>
      </Box>
